...
TABLE_NAME = "old_marathons_v1"

# 初始化 ETL 实例
etl_v1_process = MongoToPostgresETL(mongo_uri, mongo_old_db_name, postgres_uri)
...
with DAG(
    ...
    extract_task = PythonOperator(
        ...
        python_callable=etl_v1_process.extract_marathon_data,
    ...
    transform_task = PythonOperator(
        ...
        python_callable=etl_v1_process.transform_marathons,
        provide_context=True,
    )
    ...
    load_task = PythonOperator(
        ...
        python_callable=etl_v1_process.load_data,
